...
#-------------------------------------------------------------------
# Scatterplot With Encircling visulization
...
g + geom_point() + 
  ...
  labs(subtitle="mpg: city vs highway mileage", 
       ...
       caption="Source: midwest")
dim(mpg)
#the overlapping points are randomly jittered around its original position based on a threshold controlled by the width argument.
g + geom_jitter(width = .5, size=1) +
  labs(subtitle="mpg: city vs highway mileage", 
       y="hwy", 
       x="cty", 
       title="Jittered Points")
# you can insert jitter function in main algorithm
#------------------------------------------------------------------------------
# Counts Chart visulization
...
# if you have 4-Dimensional data where two of them are numeric (X and Y) and one other categorical (color) and another numeric variable (size)
...
#-----------------------------------------------------------------------
# Correlogram visulization
#let's you examine the corellation of multiple continuous variables present in the same dataframe. 
...
#--------------------------------------------------------------------------------------------
#Diverging Lollipop Chart visulization
...
ggplot(mtcars, aes(x=`car name`, y=mpg_z, label=mpg_z)) + 
  ...
  coord_flip()
#-------------------------------------------------------
#Diverging Dot Plot VISULIZATION
...
#--------------------------------------------------------------------------
#Ordered Bar Chart
#First, aggregate the data and sort it before you draw the plot. Finally, the X variable is converted to a factor.
